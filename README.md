...
- **Smart Title Extraction:** Automatically resolves the correct video title from the active webpage, preventing YouTube and other media streams from downloading with generic filenames like `videoplayback`.
